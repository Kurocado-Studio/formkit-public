...
import type { FormsNodeTree, SectionNodeTree } from '@/shared/contracts/store';
...
export const mockedForm: Form = {
  ...
  description:
    'This short demo introduces how FormKit lets you design and (soon) embed variants dynamically. You can edit any title, description, or question — just click and edit!',
  createdAt: '2025-11-11T16:05:23.351Z',
  updatedAt: '2025-11-11T16:05:23.351Z',
